...
foreach($followingposts as $post) {
 ...
 echo '<div class="post" style="float:'.$float.'">';
        echo'<div class="contents" style="float:'.$float.'">';
            ...
            echo '<a style="text-decoration:none;color:black;" href="post-details.php?token='.$token.'&post='.$post['id'].'"><div style="height:auto;width:100%;float:'.$float.';color: black;"> ';
...
<a role="presentation" href="profile_edit.php?token='.$token.'" class="profile-data-buttons2" id="edit" style="color:black;">Edit</a>
</div>'
;
...
echo '<div class="profile-links" style="width:50px;float:right;margin-top: -3px;
border-bottom: 0px solid rgb(238, 238, 238);">
<a role="presentation" href="profile_edit.php?token='.$token.'" class="profile-data-buttons2" style="color:black;" id="edit">Edit</a>
</div>';
